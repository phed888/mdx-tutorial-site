...
<Notification headerText="Example: Requirements" textColor="#00001e" icon="example" backgroundColor="#f0f0f0">
...
<Notification headerText="Example: Sample dialog" textColor="#00001e" icon="example" backgroundColor="#f0f0f0">
