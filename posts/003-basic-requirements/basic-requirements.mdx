...
<Notification headerText="What your will learn in this section" textColor="#333366" borderColor="#333366" icon="learn" backgroundColor="#eeeeff">
...
<Notification headerText="Example: Requirements" textColor="#00001e" borderColor="#999" icon="example" backgroundColor="#f0f0f0">
...
<Notification headerText="Example: Sample dialog" textColor="#00001e" borderColor="#999" icon="example" backgroundColor="#f0f0f0">
