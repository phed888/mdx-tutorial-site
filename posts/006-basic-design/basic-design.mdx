...
<Notification headerText="Prototyping the conversation" textColor="#333399" icon="example" backgroundColor="#eeeeff">
...
<Notification headerText="Partial transcript of our basic conversation" textColor="#333399" icon="example" backgroundColor="#eeeeff">
