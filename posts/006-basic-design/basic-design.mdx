...
## Best practices for building out a skill
  ...
  - For a basic conversation, that transcript might only consist of:
...
<ExternalLink linkName="Conversation design" linkURL="/basic-requirements" /> that we created back on the Requirements page.
