...
Detailed <ExternalLink linkName="instructions" linkURL="/" needed="true" /> on how to login and manage the test account as well as how to do a test run and subsequently delete that test run without having it count against our totals.
