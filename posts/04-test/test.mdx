...
## 1. CPCE User Research Hub

![Research hub landing page](./images/research-hub.png)
<figcaption>Research portal for conversational design testing</figcaption>

The <ExternalLink linkName="Research Hub" linkURL="https://confluence.expedia.biz/display/VAP/The+conversational+experience+user+research+hub" /> is a repository for all of the usability studies that have been done on the VA. This could be a great first stop in your testing plan in that you may discover studies that relate to your project.

## 2. 'Wizard of Oz' testing

![Wizard of Oz Experiment](./images/wizard.png)
<figcaption>This type of testing can be very casual (Photo by UX Indonesia on Unsplash)</figcaption>
...
- How well does your flow accommodate your subjects responses?
...
![Remote unmoderated testing](./images/usertesting.png)
<figcaption>Quickly gather feedback with unmoderated remote testing</figcaption>
...
![User testing in the lab](./images/moderated-test.png)
<figcaption>More sophisticated techniques can be applied in the lab. (Photo by UX Indonesia on Unsplash)</figcaption>
...
<PageFooter prevSlug="/visual-design" prevPage="Visual design" nextSlug="/handoff" nextPage="Handoff" />